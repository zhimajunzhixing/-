---
title: SpringBoot+Spring Security+JWT（三更草堂） (Conflicted 2023-03-08 23:43:55)
date: 2023-03-08T23:43:55Z
lastmod: 2022-12-15T20:26:50Z
---

# SpringBoot+Spring Security+JWT（三更草堂） (Conflicted 2023-03-08 23:43:55)
...
一般来说中大型的项目都是使用 **SpringSecurity** 来做安全框架。小项目有Shiro的比较多，因为相比与[SpringSecurity](https://so.csdn.net/so/search?q=SpringSecurity&spm=1001.2101.3001.7020)，Shiro的上手更加的简单。
...
​![在这里插入图片描述](assets/32a73ad68c4f45409b90e1b5982171f1-20221215202601-weq15i6.png)  
 必须登陆之后才能对接口进行访问。

* **初始账号名：user**
* **初始密码：随机生成（看控制台）**  
  ​![在这里插入图片描述](assets/808311139f4347c290f3a88fda76249b-20221215202601-34f04gk.png)​
* **默认退出接口：/logout**
...
​![在这里插入图片描述](assets/e914a5c463e945a587e1e95dcb7e057e-20221215202601-0u8yr40.png)​
...
​![在这里插入图片描述](assets/1e363f209cf34f788b517afb0519ebba-20221215202601-cv9spe6.png)  
...
​![在这里插入图片描述](assets/fb246b1c7ea04837966def97d2be25c1-20221215202601-24b9eq6.png)​

### 3.2.2 认证流程详解

​![在这里插入图片描述](assets/a097b3074e0c459796aef4e1518fffe6-20221215202601-2nqp09q.png)  
 概念速查:
...
​![在这里插入图片描述](assets/d82fc15b069e49768bfa174260334fa5-20221215202601-ozblfhl.png)  
​![在这里插入图片描述](assets/5b9167af5feb4d0eb0b943a2251f3bf3-20221215202601-bbiry94.png)​
...
#### 3.3.3.2 [密码加密](https://so.csdn.net/so/search?q=%E5%AF%86%E7%A0%81%E5%8A%A0%E5%AF%86&spm=1001.2101.3001.7020)存储（应使用数据库存储，这里使用假数据）
...
* 旧版本：我们可以定义一个SpringSecurity的配置类，SpringSecurity要求这个配置类要继承WebSecurityConfigurerAdapter。
...
* 新版本：SpringSecurity要求这个配置类**不要**继承WebSecurityConfigurerAdapter。
...
> ​![在这里插入图片描述](assets/900abe152ffd41e0bbf579ba25b11bf0-20221215202601-emp7hcr.png)​
...
​`hasRole`​方法要求有对应的角色才可以访问，但是它内部会把我们传入的参数拼接上 ROLE_ 后再去比较。所以这种情况下要用用户对应的权限也要有 ROLE_ 这个前缀才可以。
...
​`hasAnyRole`​方法 有任意的角色就可以访问。它内部也会把我们传入的参数拼接上 ROLE_ 后再去比较。所以这种情况下要用用户对应的权限也要有 ROLE_ 这个前缀才可以。
...
​![在这里插入图片描述](assets/a0c60bc8c1954a1e9fa7f48ff926db3c-20221215202601-aj2qs2o.png)​
