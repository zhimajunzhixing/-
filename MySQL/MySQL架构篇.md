---
title: MySQL架构篇
date: 2023-03-07T10:28:31Z
lastmod: 2023-03-17T09:19:18Z
---
...
![image-20220615133227202](assets/image-20220615133227202-20230307103445-z777gt0.png)

下面具体展开如下：

![image-20220615133420251](assets/image-20220615133420251-20230307103445-a6bwz9g.png)
...
![image-20220615140556893](assets/image-20220615140556893-20230307103445-mb0t1r1.png)
...
![image-20220615140710351](assets/image-20220615140710351-20230307103445-02k6nlh.png)
...
![image-20220615141934531](assets/image-20220615141934531-20230307103445-so3qf09.png)
...
​![image-20220615144537260](assets/image-20220615144537260-20230307180115-qt4hs2y.png)​
...
![image-20220615142301226](assets/image-20220615142301226-20230307103445-pq6qmpg.png)
...
![image-20220615162031427](assets/image-20220615162031427-20230307103445-twhscw7.png)

下图是SQL分词分析的过程步骤:

![image-20220615163338495](assets/image-20220615163338495-20230307103445-mqph128.png)
...
![image-20220615162613806](assets/image-20220615162613806-20230307103445-g1vhabm.png)
...
![image-20220615164722975](assets/image-20220615164722975-20230307103445-3qt5ko0.png)
...
然后我们执行一个 SQL 查询（你可以执行任何一个 SQL 查
...
![image-20220615172149919](assets/image-20220615172149919-20230307103445-0vcprm9.png)
...
![image-20220615172409967](assets/image-20220615172409967-20230307103445-mkg25eh.png)
...
![image-20220615172438338](assets/image-20220615172438338-20230307103445-71qs865.png)
...
![image-20220615173727345](assets/image-20220615173727345-20230307103445-a2c5g1b.png)
...
![image-20220615173803835](assets/image-20220615173803835-20230307103445-6y6wnla.png)

```mysql
mysql> show profile for query 2;
```

![image-20220615173822079](assets/image-20220615173822079-20230307103445-j39t5lc.png)
...
![image-20220615175309751](assets/image-20220615175309751-20230307103445-fgw222f.png)
...
![image-20220615193131719](assets/image-20220615193131719-20230307103445-s0d5ebb.png)
...
​![image-20220615214847480](assets/image-20220615214847480-20230308163705-5bl74hn.png)​你能看到此时 InnoDB 的缓冲池大小只有 134217728/1024/1024=128MB。我们可以修改缓冲池大小，比如改为256MB，方法如下：
...
​![image-20220615222455867](assets/image-20220615222455867-20230307103445-yfkjpz4.png)​
...
![image-20220615223831995](assets/image-20220615223831995-20230307103445-z84ym14.png)
...
​![image-20220615224249491](assets/image-20220615224249491-20230308164036-v3ocxh5.png)​
...
​![image-20220616124743732](assets/image-20220616124743732-20230308164322-pcj911t.png)​
...
![image-20220616125342599](assets/image-20220616125342599-20230307103445-syzdeu7.png)
...
![image-20220616125448555](assets/image-20220616125448555-20230307103445-17lw8cw.png)
...
​![image-20220616125928861](assets/image-20220616125928861-20230307103445-e540iyl.png)​

![image-20220616125945304](assets/image-20220616125945304-20230307103445-udsmc7l.png)
