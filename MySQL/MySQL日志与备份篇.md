---
title: MySQL日志与备份篇
date: 2023-03-09T12:29:10Z
lastmod: 2023-03-09T12:34:34Z
---
...
![MySQL日志与备份篇.assets/image-20220715141705004.png](assets/image-20220715141705004-20230309124315-fb54c7f.png)
...
![MySQL日志与备份篇.assets/image-20220715145650406.png](assets/image-20220715145650406-20230309124315-7fuvv0l.png)
...
![MySQL日志与备份篇.assets/image-20220715155010381.png](assets/image-20220715155010381-20230309124315-y4htrnx.png)
...
![MySQL日志与备份篇.assets/image-20220715160249271.png](assets/image-20220715160249271-20230309124315-4yukc0y.png)
...
![MySQL日志与备份篇.assets/image-20220715160657093.png](assets/image-20220715160657093-20230309124315-ao91qzx.png)
...
* 第二步：重建日志
  ...
  ![image-20220715161132368](assets/image-20220715161132368-20230309124315-lcmhd3v.png)
...
![MySQL日志与备份篇.assets/image-20220715161216556.png](assets/image-20220715161216556-20230309124315-fwib0a2.png)

### 4.4 MySQL 8.0 新特性

![MySQL日志与备份篇.assets/image-20220715161321565.png](assets/image-20220715161321565-20230309124315-dow1gco.png)
...
![MySQL日志与备份篇.assets/image-20220715161800635.png](assets/image-20220715161800635-20230309124315-we6a1rc.png)

![image-20220715161842703](assets/image-20220715161842703-20230309124315-e3ehasq.png)
...
![MySQL日志与备份篇.assets/image-20220715163520596.png](assets/image-20220715163520596-20230309124315-21xj1xk.png)
...
![MySQL日志与备份篇.assets/image-20220715163811664.png](assets/image-20220715163811664-20230309124315-nzns5ot.png)
...
![MySQL日志与备份篇.assets/image-20220715164107352.png](assets/image-20220715164107352-20230309124315-u5wq2lt.png)
...
![MySQL日志与备份篇.assets/image-20220715164718970.png](assets/image-20220715164718970-20230309124315-ov9h52s.png)

![MySQL日志与备份篇.assets/image-20220715164743351.png](assets/image-20220715164743351-20230309124315-4qy0zis.png)

![MySQL日志与备份篇.assets/image-20220715164809401.png](assets/image-20220715164809401-20230309124315-g76ymjt.png)
...
![MySQL日志与备份篇.assets/image-20220715165603879.png](assets/image-20220715165603879-20230309124315-wrb7a6y.png)
...
![MySQL日志与备份篇.assets/image-20220715171712026.png](assets/image-20220715171712026-20230309124315-y420y46.png)

![MySQL日志与备份篇.assets/image-20220715172015185.png](assets/image-20220715172015185-20230309124315-d7rtn12.png)

**2. RESET MASTER: 删除所有二进制日志文件**

![MySQL日志与备份篇.assets/image-20220715172104967.png](assets/image-20220715172104967-20230309124315-ea0zgq6.png)
...
![image-20220715172958729](assets/image-20220715172958729-20230309124315-6lq7mxy.png)
...
![image-20220715193749462](assets/image-20220715193749462-20230309124315-7yxbgt4.png)

为了安全起见，可以设置为 `1` ，表示每次提交事务都会执行fsync，就如同**redo log 刷盘流程**一样。 最后还有一种折中方式，可以设置为N(N>1)，表示每次提交事务都write，但累积N个事务后才fsync。

![image-20220715194624080](assets/image-20220715194624080-20230309124315-f05vsjh.png)
...
![image-20220715194959405](assets/image-20220715194959405-20230309124315-n08q8yd.png)
...
![image-20220715195016492](assets/image-20220715195016492-20230309124315-19zc3c2.png)

由于binlog没写完就异常，这时候binlog里面没有对应的修改记录。因此，之后用binlog日志恢复数据时，就会少这一次更新，恢复出来的这一行c值为0，而原库因为redo log日志恢复，这一行c的值是1，最终数据不一致。

![image-20220715195521986](assets/image-20220715195521986-20230309124315-0dxw6sa.png)

为了解决两份日志之间的逻辑一致问题，InnoDB存储引擎使用**两阶段提交**方案。原理很简单，将redo log的写入拆成了两个步骤prepare和commit，这就是**两阶段提交**。

![image-20220715195635196](assets/image-20220715195635196-20230309124315-0fsg2o8.png)

使用两阶段提交后，写入binlog时发生异常也不会有影响，因为MySQL根据redo log日志恢复数据时，发现redo log还处于prepare阶段，并且没有对应binlog日志，就会回滚该事务。

![image-20220715200248193](assets/image-20220715200248193-20230309124315-wpznpbe.png)

另一个场景，redo log设置commit阶段发生异常，那会不会回滚事务呢？

![image-20220715200321717](assets/image-20220715200321717-20230309124315-u2dd91u.png)
...
![image-20220715202237535](assets/image-20220715202237535-20230309124315-w0fxttr.png)
...
![image-20220715212521601](assets/image-20220715212521601-20230309124315-jr0nqs0.png)
...
![MySQL日志与备份篇.assets/image-20220715214055057.png](assets/image-20220715214055057-20230309124315-f9t9489.png)
...
![image-20220715215944767](assets/image-20220715215944767-20230309124315-w4tldlu.png)
...
![image-20220715220037213](assets/image-20220715220037213-20230309124315-lq3t8l5.png)
...
![image-20220715220852836](assets/image-20220715220852836-20230309124315-5tjsy7b.png)
...
![image-20220718140722740](assets/image-20220718140722740-20230309124315-tjhcvpr.png)
...
![image-20220718140946747](assets/image-20220718140946747-20230309124315-v1gu5pl.png)
...
![image-20220718141825228](assets/image-20220718141825228-20230309124315-2op69b1.png)

如果报错：

![image-20220718141841862](assets/image-20220718141841862-20230309124315-s8l58jh.png)
...
![image-20220718141951374](assets/image-20220718141951374-20230309124315-1wwh76d.png)
...
![MySQL日志与备份篇.assets/image-20220718142045114.png](assets/image-20220718142045114-20230309124315-1fn408t.png)
...
* 如何重新配置主从
  ...
  ![image-20220718142549168](assets/image-20220718142549168-20230309124315-0t8o0bm.png)
...
![image-20220718143705843](assets/image-20220718143705843-20230309124315-sftoml9.png)

![image-20220718143716620](assets/image-20220718143716620-20230309124315-11rrmri.png)
...
![MySQL日志与备份篇.assets/image-20220718144051094.png](assets/image-20220718144051094-20230309124315-dudzx71.png)
...
![image-20220718144341584](assets/image-20220718144341584-20230309124315-ts5fyz3.png)
...
![image-20220718144410731](assets/image-20220718144410731-20230309124315-9ujk5qs.png)

#### 方法 2：半同步复制

![MySQL日志与备份篇.assets/image-20220718144926758.png](assets/image-20220718144926758-20230309124315-hdi5f72.png)

![image-20220718144958357](assets/image-20220718144958357-20230309124315-dkpme30.png)
...
![image-20220718145235499](assets/image-20220718145235499-20230309124315-u07wzeq.png)
...
![image-20220718145428456](assets/image-20220718145428456-20230309124315-nu2v75w.png)
...
![image-20220718145523643](assets/image-20220718145523643-20230309124315-2e9amwt.png)

![image-20220718145534856](assets/image-20220718145534856-20230309124315-aiqtamn.png)

主备切换：

![image-20220718145548526](assets/image-20220718145548526-20230309124315-vl67ys9.png)
...
![MySQL日志与备份篇.assets/image-20220718145936444.png](assets/image-20220718145936444-20230309124315-fjv7m5x.png)
...
![MySQL日志与备份篇.assets/image-20220718163627669.png](assets/image-20220718163627669-20230309124315-c4zp694.png)
...
![image-20220718165515965](assets/image-20220718165515965-20230309124315-1ebcrbo.png)

## 8. 删库了不敢跑，能干点啥？

![MySQL日志与备份篇.assets/image-20220718165738367.png](assets/image-20220718165738367-20230309124315-kocttcq.png)

### 8.1 delete：误删行  

![MySQL日志与备份篇.assets/image-20220718165909464.png](assets/image-20220718165909464-20230309124315-kl5fsnt.png)

### 8.2 truncate/drop ：误删库/表

![MySQL日志与备份篇.assets/image-20220718170026929.png](assets/image-20220718170026929-20230309124315-4curh8w.png)

### 8.3 预防使用truncate/drop误删库/表

![MySQL日志与备份篇.assets/image-20220718170132339.png](assets/image-20220718170132339-20230309124315-d77cvdv.png)

![MySQL日志与备份篇.assets/image-20220718170215247.png](assets/image-20220718170215247-20230309124315-rmj7vdb.png)
