---
title: MySQL索引及调优篇
date: 2023-03-09T11:34:36Z
lastmod: 2023-03-17T16:45:51Z
---
...
![image-20220616141351236](assets/image-20220616141351236-20230309122948-47ou1uc.png)
...
![image-20220616142723266](assets/image-20220616142723266-20230309122948-3x4hgiu.png)
...
![image-20220616152453203](assets/image-20220616152453203-20230309122948-a5wf36v.png)

我们只在示意图里展示记录的这几个部分：

* record_type ：记录头信息的一项属性，表示记录的类型， 0 表示普通记录、 2 表示最小记 录、 3 表示最大记录、 1 暂时还没用过，下面讲。
*  CREATE TABLE index_demo( -> c1 INT, -> c2 INT, -> c3 CHAR(1), -> PRIMARY KEY(c1) -> ) ROW_FORMAT = Compact; next_record ：记录头信息的一项属性，表示下一条地址相对于本条记录的地址偏移量，我们用 箭头来表明下一条记录是谁。
* 各个列的值 ：这里只记录在 index_demo 表中的三个列，分别是 c1 、 c2 和 c3 。
* 其他信息 ：除了上述3种信息以外的所有信息，包括其他隐藏列的值以及记录的额外信息。

将记录格式示意图的其他信息项暂时去掉并把它竖起来的效果就是这样：

![MySQL索引及调优篇.assets/image-20220616152727234.png](assets/image-20220616152727234-20230309122948-9jc23rm.png)

把一些记录放到页里的示意图就是：

![image-20220616152651878](assets/image-20220616152651878-20230309122948-z4fysf9.png)
...
![image-20220616153518456](assets/image-20220616153518456-20230309122948-o6o2rp9.png)
...
![image-20220616155306705](assets/image-20220616155306705-20230309122948-ir1xjnq.png)
...
![image-20220616160216525](assets/image-20220616160216525-20230309122948-wtfjrmw.png)
...
![image-20220616160619525](assets/image-20220616160619525-20230309122948-awxba9k.png)
...
![image-20220616160857381](assets/image-20220616160857381-20230309122948-2nta6oi.png)
...
![image-20220616162944404](assets/image-20220616162944404-20230309122948-5kcc42a.png)
...
![image-20220616171135082](assets/image-20220616171135082-20230309122948-cspsn14.png)
...
![image-20220616173512780](assets/image-20220616173512780-20230309122948-amrtdfe.png)

如图，我们生成了一个存储更高级目录项的 页33 ，这个页中的两条记录分别代表页30和页32，如果用 户记录的主键值在 [1, 320) 之间，则到页30中查找更详细的目录项记录，如果主键值 不小于320 的 话，就到页32中查找更详细的目录项记录。

我们可以用下边这个图来描述它：

![image-20220616173717538](assets/image-20220616173717538-20230309122948-uz32vdv.png)
...
![image-20220616203852043](assets/image-20220616203852043-20230309122948-x0982xc.png)

这个B+树与上边介绍的聚簇索引有几处不同：

![image-20220616210404733](assets/image-20220616210404733-20230309122948-frat03n.png)
...
![image-20220616213109383](assets/image-20220616213109383-20230309122948-sd0uo5u.png)
...
![image-20220616215251172](assets/image-20220616215251172-20230309122948-zvb631p.png)
...
![image-20220617151918786](assets/image-20220617151918786-20230309122948-edhy4d7.png)

如果二级索引中目录项记录的内容只是 `索引列 + 页号` 的搭配的话，那么为 `c2` 列简历索引后的B+树应该长这样：

![image-20220617152906690](assets/image-20220617152906690-20230309122948-1c103zr.png)
...
![image-20220617154135258](assets/image-20220617154135258-20230309122948-yalg3zh.png)
...
![MySQL索引及调优篇.assets/image-20220617160325201.png](assets/image-20220617160325201-20230309122948-0a123z3.png)

![image-20220617160413479](assets/image-20220617160413479-20230309122948-lz98pnx.png)

![MySQL索引及调优篇.assets/image-20220617160533122.png](assets/image-20220617160533122-20230309122948-q0hk99s.png)

![image-20220617160625006](assets/image-20220617160625006-20230309122948-2sx1dtj.png)

![MySQL索引及调优篇.assets/image-20220617160813548.png](assets/image-20220617160813548-20230309122948-243a72q.png)
...
![MySQL索引及调优篇.assets/image-20220617161126022.png](assets/image-20220617161126022-20230309122948-hnnbkwx.png)

![image-20220617161151125](assets/image-20220617161151125-20230309122948-yeyv0sn.png)
...
![MySQL索引及调优篇.assets/image-20220617161635521.png](assets/image-20220617161635521-20230309122948-nnaje2l.png)
...
![MySQL索引及调优篇.assets/image-20220617161946230.png](assets/image-20220617161946230-20230309122948-9toxzuc.png)
...
![image-20220617162153587](assets/image-20220617162153587-20230309122948-oaqj5n2.png)

![MySQL索引及调优篇.assets/image-20220617162548697.png](assets/image-20220617162548697-20230309122948-3rlv6mm.png)

![image-20220617162604272](assets/image-20220617162604272-20230309122948-2e1vim5.png)

上图中哈希函数h有可能将两个不同的关键字映射到相同的位置，这叫做 碰撞 ，在数据库中一般采用 链 接法 来解决。在链接法中，将散列到同一槽位的元素放在一个链表中，如下图所示：

![image-20220617162703006](assets/image-20220617162703006-20230309122948-nmuuf3x.png)
...
![MySQL索引及调优篇.assets/image-20220617163202156.png](assets/image-20220617163202156-20230309122948-ytqt1zq.png)
...
![MySQL索引及调优篇.assets/image-20220617163619721.png](assets/image-20220617163619721-20230309122948-c4391oq.png)

![image-20220617163657697](assets/image-20220617163657697-20230309122948-y5klwz5.png)
...
![MySQL索引及调优篇.assets/image-20220617163952166.png](assets/image-20220617163952166-20230309122948-5w55510.png)

![image-20220617164022728](assets/image-20220617164022728-20230309122948-43ntn86.png)

但是特殊情况，就是有时候二叉树的深度非常大，比如：

![image-20220617164053134](assets/image-20220617164053134-20230309122948-ige0wi2.png)

为了提高查询效率，就需要 减少磁盘IO数 。为了减少磁盘IO的次数，就需要尽量 降低树的高度 ，需要把 原来“瘦高”的树结构变的“矮胖”，树的每层的分叉越多越好。

### 6.4 AVL树

![MySQL索引及调优篇.assets/image-20220617165045803.png](assets/image-20220617165045803-20230309122948-n1a2acj.png)

![image-20220617165105005](assets/image-20220617165105005-20230309122948-hxbb7uw.png)
...
![image-20220617165124685](assets/image-20220617165124685-20230309122948-wqlv48x.png)
...
![image-20220617165937875](assets/image-20220617165937875-20230309122948-corxpd4.png)

![MySQL索引及调优篇.assets/image-20220617170124200.png](assets/image-20220617170124200-20230309122948-gnd5c2t.png)
...
![MySQL索引及调优篇.assets/image-20220617170454023.png](assets/image-20220617170454023-20230309122948-gljj3r1.png)

**再举例1：**

![image-20220617170526488](assets/image-20220617170526488-20230309122948-6emdpxo.png)

### 6.6 B+Tree

![MySQL索引及调优篇.assets/image-20220617170628394.png](assets/image-20220617170628394-20230309122948-wpk94fn.png)

* MySQL官网说明：

![image-20220617170710329](assets/image-20220617170710329-20230309122948-7sdnmfh.png)
...
![MySQL索引及调优篇.assets/image-20220617171011102.png](assets/image-20220617171011102-20230309122948-sbnrnj7.png)

![image-20220617171106671](assets/image-20220617171106671-20230309122948-pysbuvi.png)

![image-20220617171131747](assets/image-20220617171131747-20230309122948-olr1u2i.png)

![MySQL索引及调优篇.assets/image-20220617171331282.png](assets/image-20220617171331282-20230309122948-tyh5lv0.png)

![MySQL索引及调优篇.assets/image-20220617171434206.png](assets/image-20220617171434206-20230309122948-g6l7bl0.png)

> B 树和 B+ 树都可以作为索引的数据结构，在 MySQL 中采用的是 B+ 树。 但B树和B+树各有自己的应用场景，不能说B+树完全比B树好，反之亦然。

**思考题：为了减少IO，索引树会一次性加载吗？**

![MySQL索引及调优篇.assets/image-20220617171614460.png](assets/image-20220617171614460-20230309122948-5ve8lwv.png)

**思考题：B+树的存储能力如何？为何说一般查找行记录，最多只需1~3次磁盘IO**

![MySQL索引及调优篇.assets/image-20220617172426725.png](assets/image-20220617172426725-20230309122948-jwi6cpa.png)

**思考题：为什么说B+树比B-树更适合实际应用中操作系统的文件索引和数据库索引？**

![MySQL索引及调优篇.assets/image-20220617175142810.png](assets/image-20220617175142810-20230309122948-7q45f04.png)

**思考题：Hash 索引与 B+ 树索引的区别**

![MySQL索引及调优篇.assets/image-20220617175230327.png](assets/image-20220617175230327-20230309122948-jphvzsr.png)

**思考题：Hash 索引与 B+ 树索引是在建索引的时候手动指定的吗？**

![MySQL索引及调优篇.assets/image-20220617175309115.png](assets/image-20220617175309115-20230309122948-h2q9bmi.png)
...
![MySQL索引及调优篇.assets/image-20220617175440527.png](assets/image-20220617175440527-20230309122948-2cg3t3g.png)

### 附录：算法的时间复杂度

同一问题可用不同算法解决，而一个算法的质量优劣将影响到算法乃至程序的效率。算法分析的目的在 于选择合适算法和改进算法。

![image-20220617175516191](assets/image-20220617175516191-20230309122948-e79xbft.png)

# 第7章_InnoDB数据存储结构

## 1. 数据库的存储结构：页

![MySQL索引及调优篇.assets/image-20220617175755324.png](assets/image-20220617175755324-20230309122948-1wb1h1c.png)

### 1.1 磁盘与内存交互基本单位：页

![MySQL索引及调优篇.assets/image-20220617193033971.png](assets/image-20220617193033971-20230309122948-r0n7xoi.png)

![image-20220617193939742](assets/image-20220617193939742-20230309122948-hixn2mj.png)

### 1.2 页结构概述

![MySQL索引及调优篇.assets/image-20220617193218557.png](assets/image-20220617193218557-20230309122948-o3cjjy6.png)
...
![image-20220617194256988](assets/image-20220617194256988-20230309122948-9pe54hs.png)

![MySQL索引及调优篇.assets/image-20220617194529699.png](assets/image-20220617194529699-20230309122948-xx2pfvl.png)
...
![image-20220617195012446](assets/image-20220617195012446-20230309122948-yeagu43.png)

如下表所示：

![image-20220617195148164](assets/image-20220617195148164-20230309122948-u4xhrfu.png)
...
![image-20220620221112635](assets/image-20220620221112635-20230309122948-uaf24tj.png)

当我们从页结构来理解 B+ 树的结构的时候，可以帮我们理解一些通过索引进行检索的原理：

![MySQL索引及调优篇.assets/image-20220620221242561.png](assets/image-20220620221242561-20230309122948-8tg9lma.png)

![MySQL索引及调优篇.assets/image-20220620221442954.png](assets/image-20220620221442954-20230309122948-ilseep3.png)
...
![MySQL索引及调优篇.assets/image-20220621134226624.png](assets/image-20220621134226624-20230309122948-njavepz.png)

### 4.2 为什么要有段？

![MySQL索引及调优篇.assets/image-20220621140802887.png](assets/image-20220621140802887-20230309122948-544jhtu.png)

### 4.3 为什么要有碎片区？

![MySQL索引及调优篇.assets/image-20220621141225223.png](assets/image-20220621141225223-20230309122948-j649g5h.png)
...
![MySQL索引及调优篇.assets/image-20220621142910222.png](assets/image-20220621142910222-20230309122948-qluvh4m.png)
...
![MySQL索引及调优篇.assets/image-20220621150648770.png](assets/image-20220621150648770-20230309122948-utspd9e.png)
...
![MySQL索引及调优篇.assets/image-20220621150924922.png](assets/image-20220621150924922-20230309122948-gjqypfv.png)
...
![MySQL索引及调优篇.assets/image-20220621151139759.png](assets/image-20220621151139759-20230309122948-bkqct9e.png)

![MySQL索引及调优篇.assets/image-20220621151158361.png](assets/image-20220621151158361-20230309122948-l5ztjto.png)

![MySQL索引及调优篇.assets/image-20220621151215274.png](assets/image-20220621151215274-20230309122948-ew9pphk.png)

![MySQL索引及调优篇.assets/image-20220621151238157.png](assets/image-20220621151238157-20230309122948-90qaune.png)
...
![image-20220621135638283](assets/image-20220621135638283-20230309122948-03hqzjn.png)

**2. 随机读取**

![MySQL索引及调优篇.assets/image-20220621135719847.png](assets/image-20220621135719847-20230309122948-95uy3jm.png)

![image-20220621135737422](assets/image-20220621135737422-20230309122948-i57u9nq.png)

**3. 顺序读取**

![MySQL索引及调优篇.assets/image-20220621135909197.png](assets/image-20220621135909197-20230309122948-q8z0m93.png)
...
![MySQL索引及调优篇.assets/image-20220621202759576.png](assets/image-20220621202759576-20230309122948-g1v0dq1.png)

**2. 唯一性索引**

![MySQL索引及调优篇.assets/image-20220621202850551.png](assets/image-20220621202850551-20230309122948-1ckopol.png)

**3. 主键索引**

![MySQL索引及调优篇.assets/image-20220621203302303.png](assets/image-20220621203302303-20230309122948-3itz70j.png)

**4. 单列索引**

![MySQL索引及调优篇.assets/image-20220621203333925.png](assets/image-20220621203333925-20230309122948-b4m8fa7.png)

**5. 多列 (组合、联合) 索引**

![MySQL索引及调优篇.assets/image-20220621203454424.png](assets/image-20220621203454424-20230309122948-7t0y7sd.png)

**6. 全文检索**

![MySQL索引及调优篇.assets/image-20220621203645789.png](assets/image-20220621203645789-20230309122948-ynga1ad.png)

**7. 补充：空间索引**

![MySQL索引及调优篇.assets/image-20220621203736098.png](assets/image-20220621203736098-20230309122948-be32qui.png)
...
![image-20220622224124267](assets/image-20220622224124267-20230309122948-xjomhyf.png)

从结果可以看出，索引仍然是默认的升序

在MySQL 8.0版本中查看数据表ts1的结构，结果如下：

![image-20220622224205048](assets/image-20220622224205048-20230309122948-5m0jypx.png)
...
![MySQL索引及调优篇.assets/image-20220623154615702.png](assets/image-20220623154615702-20230309122948-v8l56sy.png)
...
![MySQL索引及调优篇.assets/image-20220623175306282.png](assets/image-20220623175306282-20230309122948-jqup7nh.png)

#### 8. 使用字符串前缀创建索引

![MySQL索引及调优篇.assets/image-20220623175513439.png](assets/image-20220623175513439-20230309122948-0402c5h.png)
...
![MySQL索引及调优篇.assets/image-20220627151947786.png](assets/image-20220627151947786-20230309122948-hbuuo3s.png)
...
![image-20220627162248635](assets/image-20220627162248635-20230309122948-v6sigfj.png)

![image-20220627162345815](assets/image-20220627162345815-20230309122948-v5xkjoi.png)

我们可以通过观察了解数据库整体的运行状态，通过性能分析工具可以让我们了解执行慢的SQL都有哪些，查看具体的SQL执行计划，甚至是SQL执行中的每一步的成本代价，这样才能定位问题所在，找到了问题，再采取相应的行动。

**详细解释一下这张图：**

![MySQL索引及调优篇.assets/image-20220627164046438.png](assets/image-20220627164046438-20230309122948-qzwbzug.png)

![MySQL索引及调优篇.assets/image-20220627164114562.png](assets/image-20220627164114562-20230309122948-x2nxg53.png)
...
![MySQL索引及调优篇.assets/image-20220628173022699.png](assets/image-20220628173022699-20230309122948-v36ek3r.png)
...
![MySQL索引及调优篇.assets/image-20220628173525966.png](assets/image-20220628173525966-20230309122948-q18dj2v.png)
...
![MySQL索引及调优篇.assets/image-20220628175226812.png](assets/image-20220628175226812-20230309122948-llxtc2o.png)
...
![MySQL索引及调优篇.assets/image-20220628175353233.png](assets/image-20220628175353233-20230309122948-6k45ctk.png)
...
![MySQL索引及调优篇.assets/image-20220628175425922.png](assets/image-20220628175425922-20230309122948-mq77f5v.png)
...
​![MySQL索引及调优篇.assets/image-20220628195650079.png](assets/image-20220628195650079-20230309122948-m2prxl8.png)​
...
![MySQL索引及调优篇.assets/image-20220628195821440.png](assets/image-20220628195821440-20230309122948-o7bmp2g.png)
...
![MySQL索引及调优篇.assets/image-20220628203545536.png](assets/image-20220628203545536-20230309122948-qb8ewyl.png)
...
![MySQL索引及调优篇.assets/image-20220628204922556.png](assets/image-20220628204922556-20230309122948-baevoy9.png)
...
![MySQL索引及调优篇.assets/image-20220628205029208.png](assets/image-20220628205029208-20230309122948-z5hcxh8.png)
...
![MySQL索引及调优篇.assets/image-20220628205243769.png](assets/image-20220628205243769-20230309122948-w7vwktm.png)
...
![MySQL索引及调优篇.assets/image-20220628205317257.png](assets/image-20220628205317257-20230309122948-unkebi0.png)

```mysql
show profile cpu,block io for query 2
```

![MySQL索引及调优篇.assets/image-20220628205354230.png](assets/image-20220628205354230-20230309122948-uicy48e.png)
...
![MySQL索引及调优篇.assets/image-20220628210837301.png](assets/image-20220628210837301-20230309122948-a7wj8ac.png)
...
![image-20220628211207436](assets/image-20220628211207436-20230309122948-sa2p22b.png)
...
![MySQL索引及调优篇.assets/image-20220628211351678.png](assets/image-20220628211351678-20230309122948-w7v5bls.png)
...
![MySQL索引及调优篇.assets/image-20220628212029574.png](assets/image-20220628212029574-20230309122948-lhi21bw.png)

EXPLAIN 语句输出的各个列的作用如下：

![image-20220628212049096](assets/image-20220628212049096-20230309122948-tlc4hsy.png)
...
![image-20220628221143339](assets/image-20220628221143339-20230309122948-hnpwvly.png)
...
![image-20220628221414097](assets/image-20220628221414097-20230309122948-ik1d07y.png)
...
![MySQL索引及调优篇.assets/image-20220628221948512.png](assets/image-20220628221948512-20230309122948-9guk4yc.png)

```mysql
mysql > EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
```

![image-20220628222055716](assets/image-20220628222055716-20230309122948-13urdkx.png)
...
![image-20220628222251309](assets/image-20220628222251309-20230309122948-alpyay7.png)
...
![image-20220629165122837](assets/image-20220629165122837-20230309122948-6j6xiic.png)

![MySQL索引及调优篇.assets/image-20220629170848349.png](assets/image-20220629170848349-20230309122948-3au1h77.png)
...
![image-20220629165603072](assets/image-20220629165603072-20230309122948-tlz9hxn.png)
...
![image-20220629165909340](assets/image-20220629165909340-20230309122948-jebxab8.png)

![MySQL索引及调优篇.assets/image-20220629171104375.png](assets/image-20220629171104375-20230309122948-gqvevw6.png)

```mysql
 EXPLAIN SELECT * FROM s1 UNION ALL SELECT * FROM s2;
```

![image-20220629171138065](assets/image-20220629171138065-20230309122948-uqlbq0t.png)
...
![MySQL索引及调优篇.assets/image-20220629171611716.png](assets/image-20220629171611716-20230309122948-m9y4ovz.png)

![image-20220629171442624](assets/image-20220629171442624-20230309122948-ypvmtcs.png)
...
![image-20220629171840300](assets/image-20220629171840300-20230309122948-l7fqj5g.png)
...
![image-20220629171904912](assets/image-20220629171904912-20230309122948-2k7uvlj.png)
...
![image-20220629171929924](assets/image-20220629171929924-20230309122948-e2drq06.png)
...
![image-20220629172449267](assets/image-20220629172449267-20230309122948-gduwcy4.png)
...
![image-20220629172525236](assets/image-20220629172525236-20230309122948-sddr4z8.png)
...
![image-20220629172555603](assets/image-20220629172555603-20230309122948-j08m9bv.png)
...
![image-20220629172622893](assets/image-20220629172622893-20230309122948-2cdnq62.png)
...
![image-20220629172646367](assets/image-20220629172646367-20230309122948-1hyjiuq.png)
...
* <a>[https://dev.mysql.com/doc/refman/5.7/en/alter-table-partition-operations.html](https://dev.mysql.com/doc/refman/5.7/en/alter-table-partition-operations.html)</a>
...
![MySQL索引及调优篇.assets/image-20220629190304966.png](assets/image-20220629190304966-20230309122948-kg8al1o.png)
...
![MySQL索引及调优篇.assets/image-20220629190335371.png](assets/image-20220629190335371-20230309122948-0xt3usb.png)
...
![MySQL索引及调优篇.assets/image-20220630164434315.png](assets/image-20220630164434315-20230309122948-8m2r9qw.png)
...
![MySQL索引及调优篇.assets/image-20220630164724548.png](assets/image-20220630164724548-20230309122948-mkmx12n.png)
...
![MySQL索引及调优篇.assets/image-20220630164802559.png](assets/image-20220630164802559-20230309122948-9zrg2p9.png)
...
![MySQL索引及调优篇.assets/image-20220630164930020.png](assets/image-20220630164930020-20230309122948-25qchca.png)
...
![MySQL索引及调优篇.assets/image-20220630175133920.png](assets/image-20220630175133920-20230309122948-qzje7k6.png)
...
![MySQL索引及调优篇.assets/image-20220630175511644.png](assets/image-20220630175511644-20230309122948-39c9k5a.png)
...
![MySQL索引及调优篇.assets/image-20220630180123913.png](assets/image-20220630180123913-20230309122948-yo77dd3.png)
...
![image-20220703214407225](assets/image-20220703214407225-20230309122948-1e7h9w3.png)
...
![image-20220703214633338](assets/image-20220703214633338-20230309122948-gjqjixp.png)
...
![image-20220703214657251](assets/image-20220703214657251-20230309122948-ni6fnnk.png)
...
![image-20220703214844885](assets/image-20220703214844885-20230309122948-box9e98.png)
...
![image-20220703215958374](assets/image-20220703215958374-20230309122948-yue4tvc.png)
...
![image-20220703220724964](assets/image-20220703220724964-20230309122948-e2wpbhv.png)
...
![image-20220704130030692](assets/image-20220704130030692-20230309122948-j6nisa4.png)
...
![image-20220704130138204](assets/image-20220704130138204-20230309122948-4lmyup5.png)
...
![image-20220704130214482](assets/image-20220704130214482-20230309122948-umhk7nt.png)
...
![image-20220704130442095](assets/image-20220704130442095-20230309122948-rwcggbu.png)

```mysql
 EXPLAIN SELECT * FROM s1 WHERE key_part1 = 'a' AND key_part2 = 'b';
```

![image-20220704130515031](assets/image-20220704130515031-20230309122948-d0oo7np.png)
...
![MySQL索引及调优篇.assets/image-20220704131759630.png](assets/image-20220704131759630-20230309122948-tiiexib.png)

```mysql
 EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
```

![image-20220704130837498](assets/image-20220704130837498-20230309122948-jzerxq6.png)
...
![image-20220704130925426](assets/image-20220704130925426-20230309122948-795kbgy.png)

```mysql
 EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s2.key1 = UPPER(s1.key1);
```

![image-20220704130957359](assets/image-20220704130957359-20230309122948-3lqwmto.png)
...
![image-20220704131050496](assets/image-20220704131050496-20230309122948-tajlvrt.png)
...
![image-20220704131323242](assets/image-20220704131323242-20230309122948-t1vhsxu.png)
...
![image-20220704131644615](assets/image-20220704131644615-20230309122948-gfvqfhh.png)
...
![image-20220704132345383](assets/image-20220704132345383-20230309122948-3n13pvh.png)
...
![image-20220704132458978](assets/image-20220704132458978-20230309122948-effk3po.png)

##### ​`Using where`​​

![MySQL索引及调优篇.assets/image-20220704140148163.png](assets/image-20220704140148163-20230309122948-ktxx4bd.png)

```mysql
 EXPLAIN SELECT * FROM s1 WHERE common_field = 'a';
```

![image-20220704132655342](assets/image-20220704132655342-20230309122948-nv72nzj.png)

![MySQL索引及调优篇.assets/image-20220704140212813.png](assets/image-20220704140212813-20230309122948-nezmbxz.png)

```mysql
 EXPLAIN SELECT * FROM s1 WHERE key1 = 'a' AND common_field = 'a';
```

![image-20220704133130515](assets/image-20220704133130515-20230309122948-dzmp6er.png)
...
![image-20220704134324354](assets/image-20220704134324354-20230309122948-erah0ig.png)
...
![image-20220704134931220](assets/image-20220704134931220-20230309122948-scfx9bn.png)
...
![MySQL索引及调优篇.assets/image-20220704140344015.png](assets/image-20220704140344015-20230309122948-z2qpo41.png)

![MySQL索引及调优篇.assets/image-20220704140411033.png](assets/image-20220704140411033-20230309122948-ph02sc0.png)

```mysql
 EXPLAIN SELECT * FROM s1 WHERE key1 > 'z' AND key1 LIKE '%b';
```

![image-20220704140441702](assets/image-20220704140441702-20230309122948-b5u7etb.png)
...
![image-20220704140815955](assets/image-20220704140815955-20230309122948-wt6o36i.png)
...
![image-20220704142059555](assets/image-20220704142059555-20230309122948-qqwqo2m.png)
...
![image-20220704142552890](assets/image-20220704142552890-20230309122948-csqmz18.png)
...
![image-20220704142754394](assets/image-20220704142754394-20230309122948-t2glxg7.png)
...
![image-20220704142901857](assets/image-20220704142901857-20230309122948-tso99a4.png)

![MySQL索引及调优篇.assets/image-20220704145143170.png](assets/image-20220704145143170-20230309122948-9kl9lbl.png)

```mysql
 EXPLAIN SELECT * FROM s1 ORDER BY common_field LIMIT 10;
```

![image-20220704143518857](assets/image-20220704143518857-20230309122948-ktci7y5.png)

需要注意的是，如果查询中需要使用`filesort`的方式进行排序的记录非常多，那么这个过程是很耗费性能的，我们最好想办法`将使用文件排序的执行方式改为索引进行排序`。

##### ​`Using temporary`​​

![MySQL索引及调优篇.assets/image-20220704145924130.png](assets/image-20220704145924130-20230309122948-tps9g0c.png)

```mysql
 EXPLAIN SELECT DISTINCT common_field FROM s1;
```

![image-20220704150030005](assets/image-20220704150030005-20230309122948-5rhuq82.png)
...
![image-20220704150156416](assets/image-20220704150156416-20230309122948-crti7fc.png)
...
![image-20220704150308189](assets/image-20220704150308189-20230309122948-xzhrrcu.png)
...
![image-20220704161702384](assets/image-20220704161702384-20230309122948-umfs48h.png)
...
![image-20220704164236909](assets/image-20220704164236909-20230309122948-qio7hza.png)
...
![image-20220704172833362](assets/image-20220704172833362-20230309122948-mj0spl5.png)

![image-20220704172920158](assets/image-20220704172920158-20230309122948-wszguo5.png)

![image-20220704173012413](assets/image-20220704173012413-20230309122948-tz009wt.png)

![image-20220704173045190](assets/image-20220704173045190-20230309122948-lz2reql.png)

![image-20220704173108888](assets/image-20220704173108888-20230309122948-i6o2m6m.png)
...
![image-20220704174401970](assets/image-20220704174401970-20230309122948-f8b8mcp.png)
...
![image-20220704174543663](assets/image-20220704174543663-20230309122948-zffnue8.png)
...
![MySQL索引及调优篇.assets/image-20220704175711800.png](assets/image-20220704175711800-20230309122948-f2enzo3.png)
...
![MySQL索引及调优篇.assets/image-20220704190726180.png](assets/image-20220704190726180-20230309122948-kmjm3jj.png)
...
![MySQL索引及调优篇.assets/image-20220704192020603.png](assets/image-20220704192020603-20230309122948-m3o517j.png)
...
![MySQL索引及调优篇.assets/image-20220704202453482.png](assets/image-20220704202453482-20230309122948-tzkldfy.png)
...
![MySQL索引及调优篇.assets/image-20220704204140589.png](assets/image-20220704204140589-20230309122948-vhy5owl.png)
...
![image-20220704211116351](assets/image-20220704211116351-20230309122948-u5lcd3g.png)
...
![image-20220704211254581](assets/image-20220704211254581-20230309122948-1amzugl.png)
...
![MySQL索引及调优篇.assets/image-20220704212354041.png](assets/image-20220704212354041-20230309122948-yp394ou.png)

如果此时再插入一条主键值为 9 的记录，那它插入的位置就如下图：

![image-20220704212428607](assets/image-20220704212428607-20230309122948-zamfe4s.png)
...
4. 第二种：索引优化失效
   ...
   ![image-20220704214905412](assets/image-20220704214905412-20230309122948-mi5x7ob.png)
...
![image-20220704215159768](assets/image-20220704215159768-20230309122948-k47ln37.png)
...
* student表的字段name上设置有索引
  ...
  ![image-20220704215533871](assets/image-20220704215533871-20230309122948-odqdafv.png)
* 索引优化生效
  ...
  ![image-20220704215600507](assets/image-20220704215600507-20230309122948-2jzro99.png)
...
![image-20220704215658526](assets/image-20220704215658526-20230309122948-p2uxp88.png)
...
![image-20220704215721216](assets/image-20220704215721216-20230309122948-ezivd28.png)
...
![image-20220704220123647](assets/image-20220704220123647-20230309122948-ybn1n18.png)
...
![image-20220704223211981](assets/image-20220704223211981-20230309122948-0prq2qy.png)
...
![image-20220704224552374](assets/image-20220704224552374-20230309122948-bl1poxg.png)
...
![image-20220704224916117](assets/image-20220704224916117-20230309122948-nmbexmr.png)
...
![image-20220704225333199](assets/image-20220704225333199-20230309122948-03k9tbd.png)
...
![image-20220705131643304](assets/image-20220705131643304-20230309122948-cjw87dz.png)
...
![image-20220705131717329](assets/image-20220705131717329-20230309122948-xogh6ay.png)
...
![image-20220705132221045](assets/image-20220705132221045-20230309122948-63iwm10.png)
...
![image-20220705132239232](assets/image-20220705132239232-20230309122948-w9kzlh8.png)
...
![image-20220705145225852](assets/image-20220705145225852-20230309122948-umodva5.png)
...
![image-20220705160504018](assets/image-20220705160504018-20230309122948-nannlnv.png)
...
![image-20220705160935109](assets/image-20220705160935109-20230309122948-828q19e.png)
...
![image-20220705161243838](assets/image-20220705161243838-20230309122948-94yqi0a.png)
...
![image-20220705161515545](assets/image-20220705161515545-20230309122948-ghij3pj.png)
...
![image-20220705161602362](assets/image-20220705161602362-20230309122948-b08i53h.png)
...
![image-20220705161746184](assets/image-20220705161746184-20230309122948-evzal7u.png)
...
![image-20220705161843558](assets/image-20220705161843558-20230309122948-jzn34c0.png)
...
![image-20220705161929544](assets/image-20220705161929544-20230309122948-ynr0i1v.png)
...
![image-20220705162009145](assets/image-20220705162009145-20230309122948-terv9gh.png)
...
![image-20220705163833445](assets/image-20220705163833445-20230309122948-p2ojasy.png)
...
![image-20220705165559127](assets/image-20220705165559127-20230309122948-ujz1r0l.png)

可以看到这种方式效率是非常低的，以上述表A数据100条，表B数据1000条计算，则A*B=10万次。开销统计如下:

![image-20220705165646252](assets/image-20220705165646252-20230309122948-05zdmuh.png)
...
![image-20220705172315554](assets/image-20220705172315554-20230309122948-smfrvka.png)

驱动表中的每条记录通过被驱动表的索引进行访问，因为索引查询的成本是比较固定的，故mysql优化器都倾向于使用记录数少的表作为驱动表（外表）。

![image-20220705172650749](assets/image-20220705172650749-20230309122948-c2eankh.png)

如果被驱动表加索引，效率是非常高的，但如果索引不是主键索引，所以还得进行一次回表查询。相比，被驱动表的索引是主键索引，效率会更高。

#### 4. Block Nested-Loop Join（块嵌套循环连接）

![MySQL索引及调优篇.assets/image-20220705173047234.png](assets/image-20220705173047234-20230309122948-bcmaf1s.png)
...
![image-20220705174005280](assets/image-20220705174005280-20230309122948-g7wft1y.png)

![image-20220705174250551](assets/image-20220705174250551-20230309122948-a2t5gv4.png)
...
![image-20220705205050280](assets/image-20220705205050280-20230309122948-eu3ngj6.png)
...
![image-20220705210708343](assets/image-20220705210708343-20230309122948-ywztp6x.png)
...
![image-20220705210839437](assets/image-20220705210839437-20230309122948-nujcnds.png)
...
![image-20220705215436102](assets/image-20220705215436102-20230309122948-tene6hy.png)

**过程二： order by 时不limit,索引失效**

![image-20220705215909350](assets/image-20220705215909350-20230309122948-mfg335x.png)

**过程三：order by 时顺序错误，索引失效**

![MySQL索引及调优篇.assets/image-20220705220033520.png](assets/image-20220705220033520-20230309122948-hg9geni.png)

**过程四：order by 时规则不一致，索引失效（顺序错，不索引；方向反，不索引）**

![MySQL索引及调优篇.assets/image-20220705220404802.png](assets/image-20220705220404802-20230309122948-gcjbn7j.png)

> 结论：ORDER BY 子句，尽量使用 Index 方式排序，避免使用 FileSort 方式排序

**过程五：无过滤，不索引**

![MySQL索引及调优篇.assets/image-20220705221212879.png](assets/image-20220705221212879-20230309122948-s8vtocd.png)
...
![image-20220705222027812](assets/image-20220705222027812-20230309122948-8bd9ntb.png)
...
![image-20220705222912521](assets/image-20220705222912521-20230309122948-eugxtj1.png)

这样我们优化掉了 using filesort

查询结果如下：

![MySQL索引及调优篇.assets/image-20220705222954971.png](assets/image-20220705222954971-20230309122948-l5nh378.png)
...
![image-20220705223111883](assets/image-20220705223111883-20230309122948-nqjtd20.png)
...
![MySQL索引及调优篇.assets/image-20220705223329164.png](assets/image-20220705223329164-20230309122948-jzlon7t.png)
...
![MySQL索引及调优篇.assets/image-20220705224410340.png](assets/image-20220705224410340-20230309122948-1mdya0c.png)

**2. 尝试提高 max_length_for_sort_data**

![MySQL索引及调优篇.assets/image-20220705224505668.png](assets/image-20220705224505668-20230309122948-iuxbcil.png)

**3. Order by 时select * 是一个大忌。最好只Query需要的字段。**

![MySQL索引及调优篇.assets/image-20220705224551104.png](assets/image-20220705224551104-20230309122948-8c4tscb.png)
...
![MySQL索引及调优篇.assets/image-20220705225329130.png](assets/image-20220705225329130-20230309122948-oqvqxoz.png)
...
![image-20220705225625166](assets/image-20220705225625166-20230309122948-pc9dwr4.png)
...
![image-20220705225654124](assets/image-20220705225654124-20230309122948-mhxlct4.png)
...
![image-20220706124528680](assets/image-20220706124528680-20230309122948-jyu145i.png)
...
![image-20220706124612180](assets/image-20220706124612180-20230309122948-xxqo8fq.png)
...
![image-20220706125113658](assets/image-20220706125113658-20230309122948-f93f8zx.png)
...
![image-20220706125351116](assets/image-20220706125351116-20230309122948-4q1hd23.png)

### 8.2 覆盖索引的利弊

![MySQL索引及调优篇.assets/image-20220706125943936.png](assets/image-20220706125943936-20230309122948-eu6s8bp.png)
...
![image-20220706130901307](assets/image-20220706130901307-20230309122948-ui2q029.png)

以及

![MySQL索引及调优篇.assets/image-20220706130921934.png](assets/image-20220706130921934-20230309122948-tvbwb6f.png)
...
![MySQL索引及调优篇.assets/image-20220706131320477.png](assets/image-20220706131320477-20230309122948-ew3rx5f.png)
...
![MySQL索引及调优篇.assets/image-20220706135436316.png](assets/image-20220706135436316-20230309122948-b8phk62.png)

![MySQL索引及调优篇.assets/image-20220706135506409.png](assets/image-20220706135506409-20230309122948-5abaici.png)

* 主键索引 (简图)

![image-20220706135633814](assets/image-20220706135633814-20230309122948-sm60c0m.png)

二级索引zip_last_first (简图，这里省略了数据页等信息)

![image-20220706135701187](assets/image-20220706135701187-20230309122948-5eid1r1.png)

![MySQL索引及调优篇.assets/image-20220706135723203.png](assets/image-20220706135723203-20230309122948-sql76st.png)

### 10.4 开启和关闭ICP性能对比

![MySQL索引及调优篇.assets/image-20220706135904713.png](assets/image-20220706135904713-20230309122948-sjm7tvi.png)

![MySQL索引及调优篇.assets/image-20220706140213382.png](assets/image-20220706140213382-20230309122948-86wcvcz.png)
...
![MySQL索引及调优篇.assets/image-20220706141957185.png](assets/image-20220706141957185-20230309122948-sbdwynf.png)
...
​![MySQL索引及调优篇.assets/image-20220706142648452.png](assets/image-20220706142648452-20230309122948-kjvcol9.png)​
...
![image-20220706151506580](assets/image-20220706151506580-20230309122948-gagp2i0.png)
...
![image-20220706151715106](assets/image-20220706151715106-20230309122948-v445udo.png)
...
![image-20220706161436920](assets/image-20220706161436920-20230309122948-g1oxry3.png)
...
![image-20220706162131362](assets/image-20220706162131362-20230309122948-jg41r2w.png)
...
![image-20220706162657448](assets/image-20220706162657448-20230309122948-o2zv8hn.png)
...
![MySQL索引及调优篇.assets/image-20220706162947613.png](assets/image-20220706162947613-20230309122948-wbo9f25.png)
...
![MySQL索引及调优篇.assets/image-20220706164201695.png](assets/image-20220706164201695-20230309122948-86gqj2d.png)

![MySQL索引及调优篇.assets/image-20220706164359539.png](assets/image-20220706164359539-20230309122948-oe96yb3.png)
...
![image-20220706165020939](assets/image-20220706165020939-20230309122948-m9t0ctb.png)

### 2.3 键和相关属性的概念

![MySQL索引及调优篇.assets/image-20220706165231022.png](assets/image-20220706165231022-20230309122948-kqpqwib.png)
...
![image-20220706171057270](assets/image-20220706171057270-20230309122948-214je5m.png)

该表不符合 1NF ，因为规则说“表的每个属性必须具有原子（单个）值”，lisi和zhaoliu员工的 emp_mobile 值违反了该规则。为了使表符合 1NF ，我们应该有如下表数据：

![image-20220706171130851](assets/image-20220706171130851-20230309122948-n6l7xc0.png)

**举例2：**

user 表的设计不符合第一范式

![image-20220706171225292](assets/image-20220706171225292-20230309122948-olk2h48.png)

其中，user_info字段为用户信息，可以进一步拆分成更小粒度的字段，不符合数据库设计对第一范式的 要求。将user_info拆分后如下：

![image-20220706171242455](assets/image-20220706171242455-20230309122948-a01ke8k.png)
...
![image-20220706171442919](assets/image-20220706171442919-20230309122948-et3m09g.png)

表2：

![image-20220706171456873](assets/image-20220706171456873-20230309122948-co6bzc8.png)
...
![image-20220707122639894](assets/image-20220707122639894-20230309122948-vmnsaps.png)
...
![image-20220707123038469](assets/image-20220707123038469-20230309122948-vghlua9.png)
...
![image-20220707123104009](assets/image-20220707123104009-20230309122948-k0i7tn5.png)
...
![image-20220707124011654](assets/image-20220707124011654-20230309122948-228zbjj.png)
...
![image-20220707124040899](assets/image-20220707124040899-20230309122948-6vqjizt.png)

表2：符合第三范式的 `商品表` 的设计

![image-20220707124058174](assets/image-20220707124058174-20230309122948-ryslrow.png)
...
![image-20220707124136228](assets/image-20220707124136228-20230309122948-kma0iqo.png)

你能看到球员编号决定了球队名称，同时球队名称决定了球队主教练，非主属性球队主教练就会传递依 赖于球员编号，因此不符合 3NF 的要求。

如果要达到 3NF 的要求，需要把数据表拆成下面这样：

![image-20220707124152312](assets/image-20220707124152312-20230309122948-lzax7k7.png)
...
![image-20220707124212114](assets/image-20220707124212114-20230309122948-90h6m6t.png)

> 符合3NF后的数据模型通俗地讲，2NF和3NF通常以这句话概括：“每个非键属性依赖于键，依赖于 整个键，并且除了键别无他物”。

### 2.7 小结

![MySQL索引及调优篇.assets/image-20220707124343085.png](assets/image-20220707124343085-20230309122948-2nayiku.png)

## 3. 反范式化

### 3.1 概述

![MySQL索引及调优篇.assets/image-20220707124741675.png](assets/image-20220707124741675-20230309122948-mq1we4i.png)
...
![image-20220707125118808](assets/image-20220707125118808-20230309122948-v36iytj.png)
...
![image-20220707125401029](assets/image-20220707125401029-20230309122948-kvuxv8o.png)

商品信息表：

![image-20220707125447317](assets/image-20220707125447317-20230309122948-1ugun9a.png)

新的商品流水表如下所示：

![image-20220707125500378](assets/image-20220707125500378-20230309122948-xw1ip3b.png)

**举例4：**

`课程评论表 class_comment` ，对应的字段名称及含义如下：

![image-20220707125531172](assets/image-20220707125531172-20230309122948-dx318zy.png)

`学生表 student` ，对应的字段名称及含义如下：

![MySQL索引及调优篇.assets/image-20220707125545891.png](assets/image-20220707125545891-20230309122948-2sinr0y.png)
...
![MySQL索引及调优篇.assets/image-20220707125642908.png](assets/image-20220707125642908-20230309122948-zy3dw4i.png)
...
![MySQL索引及调优篇.assets/image-20220707125718469.png](assets/image-20220707125718469-20230309122948-63x08rl.png)
...
![MySQL索引及调优篇.assets/image-20220707131428597.png](assets/image-20220707131428597-20230309122948-qze7yvd.png)
...
![image-20220707132038425](assets/image-20220707132038425-20230309122948-d2livz6.png)
...
![image-20220707132344634](assets/image-20220707132344634-20230309122948-016s7pm.png)

导师表：

![image-20220707132355841](assets/image-20220707132355841-20230309122948-ys76c6b.png)
...
![image-20220707133830721](assets/image-20220707133830721-20230309122948-mb8227q.png)
...
![image-20220707134028730](assets/image-20220707134028730-20230309122948-oxfolh2.png)

以及

![image-20220707134220820](assets/image-20220707134220820-20230309122948-escosh8.png)
...
![image-20220707134636225](assets/image-20220707134636225-20230309122948-h247fi4.png)
...
![image-20220707154400580](assets/image-20220707154400580-20230309122948-3bgecix.png)
...
![MySQL索引及调优篇.assets/image-20220707163807205.png](assets/image-20220707163807205-20230309122948-mi6z7t1.png)

进货单表：

![MySQL索引及调优篇.assets/image-20220707163828614.png](assets/image-20220707163828614-20230309122948-dqtrr0p.png)
...
![image-20220707164128704](assets/image-20220707164128704-20230309122948-ubvwydv.png)

进货单明细表：

![image-20220707164146216](assets/image-20220707164146216-20230309122948-ranbzut.png)

商品信息表：

![image-20220707164227845](assets/image-20220707164227845-20230309122948-c7uye58.png)
...
![MySQL索引及调优篇.assets/image-20220707165011050.png](assets/image-20220707165011050-20230309122948-5noa26v.png)

进货单头表：

![MySQL索引及调优篇.assets/image-20220707165038108.png](assets/image-20220707165038108-20230309122948-m278sx0.png)

这2个表都满足第三范式的要求了。

### 7.4 反范式化：业务优先的原则

![MySQL索引及调优篇.assets/image-20220707165459547.png](assets/image-20220707165459547-20230309122948-xy6ru8b.png)

因此，最后我们可以把进货单表拆分成下面的4个表：

供货商表：

![MySQL索引及调优篇.assets/image-20220707165011050.png](assets/image-20220707165011050-20230309122948-0khg2mk.png)

进货单头表：

![MySQL索引及调优篇.assets/image-20220707165038108.png](assets/image-20220707165038108-20230309122948-owxqzt0.png)

进货单明细表：

![MySQL索引及调优篇.assets/image-20220707164146216.png](assets/image-20220707164146216-20230309122948-p83yooe.png)

商品信息表：

![MySQL索引及调优篇.assets/image-20220707164227845.png](assets/image-20220707164227845-20230309122948-ifg4ycf.png)

这样一来，我们就避免了冗余数据，而且还能够满足业务的需求，这样的数据库设计，才是合格的设计。

## 8. ER模型

![MySQL索引及调优篇.assets/image-20220707170027637.png](assets/image-20220707170027637-20230309122948-amlfigs.png)
...
![image-20220707170608782](assets/image-20220707170608782-20230309122948-tivljlj.png)
...
![image-20220707171022246](assets/image-20220707171022246-20230309122948-n23iuhk.png)
...
​![MySQL索引及调优篇.assets/image-20220707171335255.png](assets/image-20220707171335255-20230309122948-qv3ij3d.png)​

![MySQL索引及调优篇.assets/image-20220707171412363.png](assets/image-20220707171412363-20230309122948-ymbui0r.png)

![MySQL索引及调优篇.assets/image-20220707171915637.png](assets/image-20220707171915637-20230309122948-xa3ewk5.png)

**下面我们再把弱实体转换成数据表：**

![MySQL索引及调优篇.assets/image-20220707172033399.png](assets/image-20220707172033399-20230309122948-bitpdtd.png)

![MySQL索引及调优篇.assets/image-20220707172052236.png](assets/image-20220707172052236-20230309122948-lvbk5y6.png)

![MySQL索引及调优篇.assets/image-20220707172143793.png](assets/image-20220707172143793-20230309122948-lrapltv.png)

![MySQL索引及调优篇.assets/image-20220707172217772.png](assets/image-20220707172217772-20230309122948-a74k63l.png)

![MySQL索引及调优篇.assets/image-20220707172236606.png](assets/image-20220707172236606-20230309122948-62olzo0.png)

![MySQL索引及调优篇.assets/image-20220707172259143.png](assets/image-20220707172259143-20230309122948-5sys136.png)

#### 2. 一个多对多的关系转换成一个数据表

![MySQL索引及调优篇.assets/image-20220707172350226.png](assets/image-20220707172350226-20230309122948-gy3sxlh.png)

#### 3. 通过外键来表达1对多的关系

![MySQL索引及调优篇.assets/image-20220707172609833.png](assets/image-20220707172609833-20230309122948-l73hjs0.png)

#### 4. 把属性转换成表的字段

![MySQL索引及调优篇.assets/image-20220707172819174.png](assets/image-20220707172819174-20230309122948-y5xdx22.png)

![image-20220707172918017](assets/image-20220707172918017-20230309122948-j7h976e.png)
...
![MySQL索引及调优篇.assets/image-20220707173028203.png](assets/image-20220707173028203-20230309122948-t4ijkfy.png)

**2. 数据表中的字段个数越少越好**

![MySQL索引及调优篇.assets/image-20220707173402491.png](assets/image-20220707173402491-20230309122948-erh9hvm.png)

**3. 数据表中联合主键的字段个数越少越好**

![MySQL索引及调优篇.assets/image-20220707173522971.png](assets/image-20220707173522971-20230309122948-nysoev2.png)

**4. 使用主键和外键越多越好**

![MySQL索引及调优篇.assets/image-20220707173557568.png](assets/image-20220707173557568-20230309122948-5jsbbjs.png)
...
![MySQL索引及调优篇.assets/image-20220707175250944.png](assets/image-20220707175250944-20230309122948-1noota8.png)
...
![MySQL索引及调优篇.assets/image-20220707175350250.png](assets/image-20220707175350250-20230309122948-s9aii79.png)

点击上面的ok，即可出现下图左边的概念模型1，可以自定义概念模型的名字，在概念模型中使用最多的 就是如图所示的Entity(实体),Relationship(关系)

![MySQL索引及调优篇.assets/image-20220707175604026.png](assets/image-20220707175604026-20230309122948-ijieu37.png)

**Entity实体**

选中右边框中Entity这个功能，即可出现下面这个方框，需要注意的是书写name的时候，code自行补全，name可以是英文的也可以是中文的，但是code必须是英文的。

![MySQL索引及调优篇.assets/image-20220707175653689.png](assets/image-20220707175653689-20230309122948-6eorugu.png)
...
![MySQL索引及调优篇.assets/image-20220707175805226.png](assets/image-20220707175805226-20230309122948-bzve4tt.png)

在此上图说明name和code的起名方法

![MySQL索引及调优篇.assets/image-20220707175827417.png](assets/image-20220707175827417-20230309122948-qlbomhk.png)
...
![MySQL索引及调优篇.assets/image-20220707175858031.png](assets/image-20220707175858031-20230309122948-vosww0m.png)

**放大模型**

创建好概念数据模型如图所示，但是创建好的字体很小，读者可以按着ctrl键同时滑动鼠标的可滑动按钮 即可放大缩写字体，同时也可以看到主标识符有一个*号的标志，同时也显示出来了，name,Data type和 length这些可见的属性

![MySQL索引及调优篇.assets/image-20220707175925155.png](assets/image-20220707175925155-20230309122948-egq0gsx.png)
...
![MySQL索引及调优篇.assets/image-20220707175954634.png](assets/image-20220707175954634-20230309122948-gsuugjq.png)

需要注意的是点击Relationship这个按钮，就把班级和学生联系起来了，就是一条线，然后双击这条线进 行编辑，在General这块起name和code

![MySQL索引及调优篇.assets/image-20220707180021612.png](assets/image-20220707180021612-20230309122948-xej9k35.png)

上面的name和code起好后就可以在Cardinalities这块查看班级和学生的关系，可以看到班级的一端是一 条线，学生的一端是三条，代表班级对学生是一对多的关系即one对many的关系，点击应用，然后确定 即可

![MySQL索引及调优篇.assets/image-20220707180044291.png](assets/image-20220707180044291-20230309122948-tsi3fhu.png)

一对多和多对一练习完还有多对多的练习，如下图操作所示，老师实体和上面介绍的一样，自己将 name，data type等等修改成自己需要的即可，满足项目开发需求即可。（comment是解释说明，自己可以写相关的介绍和说明）

![MySQL索引及调优篇.assets/image-20220707180113532.png](assets/image-20220707180113532-20230309122948-y22656j.png)

多对多需要注意的是自己可以手动点击按钮将关系调整称为多对多的关系many对many的关系，然后点击应用和确定即可

![MySQL索引及调优篇.assets/image-20220707180159184.png](assets/image-20220707180159184-20230309122948-zj9txdn.png)

综上即可完成最简单的学生，班级，教师这种概念数据模型的设计，需要考虑数据的类型和主标识码， 是否为空。关系是一对一还是一对多还是多对多的关系，自己需要先规划好再设计，然后就ok了。

![image-20220707180254510](assets/image-20220707180254510-20230309122948-h5pw167.png)
...
![MySQL索引及调优篇.assets/image-20220707180327712.png](assets/image-20220707180327712-20230309122948-r6okwn4.png)

创建好主页面如图所示，但是右边的按钮和概念模型略有差别，物理模型最常用的三个是 `table(表)` ， `view(视图)`， `reference(关系) ​`；

![MySQL索引及调优篇.assets/image-20220707180418090.png](assets/image-20220707180418090-20230309122948-65v3w81.png)

鼠标先点击右边table这个按钮然后在新建的物理模型点一下，即可新建一个表，然后双击新建如下图所示，在General的name和code填上自己需要的，点击应用即可），如下图：

![MySQL索引及调优篇.assets/image-20220707180449212.png](assets/image-20220707180449212-20230309122948-2b3iurc.png)

然后点击Columns,如下图设置，非常简单，需要注意的就是P（primary主键） , F （foreign key外键） , M（mandatory强制性的，代表不可为空） 这三个。

![MySQL索引及调优篇.assets/image-20220707180537251.png](assets/image-20220707180537251-20230309122948-w5drr2y.png)

在此设置学号的自增（MYSQL里面的自增是这个AUTO_INCREMENT），班级编号同理，不多赘述！

![MySQL索引及调优篇.assets/image-20220707180556645.png](assets/image-20220707180556645-20230309122948-hr55rpf.png)

在下面的这个点上对号即可，就设置好了自增

![MySQL索引及调优篇.assets/image-20220707180619440.png](assets/image-20220707180619440-20230309122948-at4z069.png)

全部完成后如下图所示。

![MySQL索引及调优篇.assets/image-20220707180643107.png](assets/image-20220707180643107-20230309122948-8fh9kur.png)

班级物理模型同理如下图所示创建即可

![MySQL索引及调优篇.assets/image-20220707180723698.png](assets/image-20220707180723698-20230309122948-yr7e6ah.png)

![MySQL索引及调优篇.assets/image-20220707180744600.png](assets/image-20220707180744600-20230309122948-1s7lpx5.png)

完成后如下图所示

![MySQL索引及调优篇.assets/image-20220707180806150.png](assets/image-20220707180806150-20230309122948-8uz5xhy.png)
...
![MySQL索引及调优篇.assets/image-20220707180828164.png](assets/image-20220707180828164-20230309122948-pkoc6oo.png)

做完上面的操作，就可以双击中间的一条线，显示如下图，修改name和code即可

![MySQL索引及调优篇.assets/image-20220707183743297.png](assets/image-20220707183743297-20230309122948-4vjojv7.png)

但是需要注意的是，修改完毕后显示的结果却如下图所示，并没有办法直接像概念模型那样，修改过后 显示在中间的那条线上面，自己明白即可。

![MySQL索引及调优篇.assets/image-20220707193816176.png](assets/image-20220707193816176-20230309122948-yc0mkzy.png)

学习了多对一或者一对多的关系，接下来学习多对对的关系，同理自己建好老师表，这里不在叙述，记得老师编号自增，建好如下图所示

![MySQL索引及调优篇.assets/image-20220707193932694.png](assets/image-20220707193932694-20230309122948-zabk4u1.png)

下面是多对多关系的关键，由于物理模型多对多的关系需要一个中间表来连接，如下图，只设置一个字 段，主键，自增

![MySQL索引及调优篇.assets/image-20220707193957629.png](assets/image-20220707193957629-20230309122948-xj40mds.png)

点击应用，然后设置Columns，只添加一个字段

![MySQL索引及调优篇.assets/image-20220707194048843.png](assets/image-20220707194048843-20230309122948-efoeag8.png)

这是设置字段递增，前面已经叙述过好几次

![MySQL索引及调优篇.assets/image-20220707194111885.png](assets/image-20220707194111885-20230309122948-4yz1bzs.png)

设置好后如下图所示，需要注意的是有箭头的一方是一，无箭头的一方是多，即一对多的多对一的关系 需要搞清楚，学生也可以有很多老师，老师也可以有很多学生，所以学生和老师都可以是主体；

![MySQL索引及调优篇.assets/image-20220707194138137.png](assets/image-20220707194138137-20230309122948-xnrxh36.png)

可以看到添加关系以后学生和教师的关系表前后发生的变化

![MySQL索引及调优篇.assets/image-20220707194158936.png](assets/image-20220707194158936-20230309122948-jy0w5jd.png)

### 11.4 概念模型转为物理模型

1：如下图所示先打开概念模型图，然后点击Tool,如下图所示

![image-20220707194228064](assets/image-20220707194228064-20230309122948-ebltber.png)

点开的页面如下所示，name和code已经从概念模型1改成物理模型1了

![image-20220707194248236](assets/image-20220707194248236-20230309122948-zaekk6l.png)

完成后如下图所示，将自行打开修改的物理模型，需要注意的是这些表的数据类型已经自行改变了，而 且中间表出现两个主键，即双主键

![image-20220707194308595](assets/image-20220707194308595-20230309122948-hhbgknc.png)

### 11.5 物理模型转为概念模型

上面介绍了概念模型转物理模型，下面介绍一下物理模型转概念模型（如下图点击操作即可）

![image-20220707194405358](assets/image-20220707194405358-20230309122948-ewqjh83.png)

然后出现如下图所示界面，然后将物理修改为概念 ，点击应用确认即可

![image-20220707194419360](assets/image-20220707194419360-20230309122948-f0wimxv.png)

点击确认后将自行打开如下图所示的页面，自己观察有何变化，如果转换为oracle的，数据类型会发生变 化，比如Varchar2等等）；

![image-20220707194433407](assets/image-20220707194433407-20230309122948-i8gbl9t.png)

### 11.6 物理模型导出SQL语句

![image-20220707194544714](assets/image-20220707194544714-20230309122948-2b92nht.png)

打开之后如图所示，修改好存在sql语句的位置和生成文件的名称即可

![image-20220707194557554](assets/image-20220707194557554-20230309122948-yanhjbb.png)

在Selection中选择需要导出的表，然后点击应用和确认即可

![image-20220707194637242](assets/image-20220707194637242-20230309122948-97xocma.png)

完成以后出现如下图所示，可以点击Edit或者close按钮

![image-20220707194727849](assets/image-20220707194727849-20230309122948-0l3gy8t.png)
...
![MySQL索引及调优篇.assets/image-20220707200915836.png](assets/image-20220707200915836-20230309122948-jtc5tzh.png)

如何确定呢？一般情况下，有如下几种方式：

![MySQL索引及调优篇.assets/image-20220707201133424.png](assets/image-20220707201133424-20230309122948-0pyzutu.png)
...
![MySQL索引及调优篇.assets/image-20220707201443229.png](assets/image-20220707201443229-20230309122948-ifqtohc.png)

#### 第2步：优化表设计

![MySQL索引及调优篇.assets/image-20220707201617799.png](assets/image-20220707201617799-20230309122948-ydu2jvq.png)

#### 第3步：优化逻辑查询

![MySQL索引及调优篇.assets/image-20220707202059972.png](assets/image-20220707202059972-20230309122948-r1wzd9y.png)

#### 第4步：优化物理查询

物理查询优化是在确定了逻辑查询优化之后，采用物理优化技术（比如索引等），通过计算代价模型对 各种可能的访问路径进行估算，从而找到执行方式中代价最小的作为执行计划。**在这个部分中，我们需要掌握的重点是对索引的创建和使用。**

![MySQL索引及调优篇.assets/image-20220707202156660.png](assets/image-20220707202156660-20230309122948-9wx5ws3.png)
...
![MySQL索引及调优篇.assets/image-20220707202436467.png](assets/image-20220707202436467-20230309122948-6pkzgub.png)

#### 第6步：库级优化

![MySQL索引及调优篇.assets/image-20220707202555506.png](assets/image-20220707202555506-20230309122948-xbvk1kn.png)

![MySQL索引及调优篇.assets/image-20220707202732911.png](assets/image-20220707202732911-20230309122948-lekh5xl.png)

![MySQL索引及调优篇.assets/image-20220707203538155.png](assets/image-20220707203538155-20230309122948-kj8kzuf.png)

![MySQL索引及调优篇.assets/image-20220707203607993.png](assets/image-20220707203607993-20230309122948-23t8rw6.png)

> 但需要注意的是，分拆在提升数据库性能的同时，也会增加维护和使用成本。

## 2. 优化MySQL服务器

​![MySQL索引及调优篇.assets/image-20220707203818987.png](assets/image-20220707203818987-20230309122948-spybj19.png)​
...
![MySQL索引及调优篇.assets/image-20220707204403406.png](assets/image-20220707204403406-20230309122948-e002lvt.png)
...
![MySQL索引及调优篇.assets/image-20220707210351452.png](assets/image-20220707210351452-20230309122948-vmahn3g.png)

**(1) 调整系统参数 InnoDB_flush_log_at_trx_commit**

![MySQL索引及调优篇.assets/image-20220707210447501.png](assets/image-20220707210447501-20230309122948-jdapd7f.png)

**(2)  调整系统参数 InnoDB_buffer_pool_size**

![MySQL索引及调优篇.assets/image-20220707210555848.png](assets/image-20220707210555848-20230309122948-nbuzj9m.png)

**(3) 调整系统参数 InnoDB_buffer_pool_instances**

![MySQL索引及调优篇.assets/image-20220707210720394.png](assets/image-20220707210720394-20230309122948-932kjp4.png)

## 3. 优化数据库结构

![MySQL索引及调优篇.assets/image-20220707211709553.png](assets/image-20220707211709553-20230309122948-drgq8np.png)

### 3.1 拆分表：冷热数据分离

![MySQL索引及调优篇.assets/image-20220707211802756.png](assets/image-20220707211802756-20230309122948-f75owlu.png)
...
![MySQL索引及调优篇.assets/image-20220707212800544.png](assets/image-20220707212800544-20230309122948-kckkeno.png)
...
![MySQL索引及调优篇.assets/image-20220707213524137.png](assets/image-20220707213524137-20230309122948-d6x5wjq.png)
...
![MySQL索引及调优篇.assets/image-20220707214640374.png](assets/image-20220707214640374-20230309122948-ss9o9rm.png)
...
![MySQL索引及调优篇.assets/image-20220707215305640.png](assets/image-20220707215305640-20230309122948-r0eh5nj.png)

**② 禁用唯一性检查**

![MySQL索引及调优篇.assets/image-20220707215356893.png](assets/image-20220707215356893-20230309122948-ll0n9vu.png)
...
![MySQL索引及调优篇.assets/image-20220707220034534.png](assets/image-20220707220034534-20230309122948-ppdn5c0.png)

**③ 禁止自动提交**

![MySQL索引及调优篇.assets/image-20220707220131891.png](assets/image-20220707220131891-20230309122948-grx6kah.png)

### 3.6 使用非空约束

![MySQL索引及调优篇.assets/image-20220707220157606.png](assets/image-20220707220157606-20230309122948-x6z8mft.png)
...
![image-20220707221707254](assets/image-20220707221707254-20230309122948-qwgr07y.png)
...
![image-20220707221901664](assets/image-20220707221901664-20230309122948-lzp336t.png)
...
![MySQL索引及调优篇.assets/image-20220707222156765.png](assets/image-20220707222156765-20230309122948-nf83mgg.png)

**方式二：使用mysqlcheck命令**

![MySQL索引及调优篇.assets/image-20220707222305302.png](assets/image-20220707222305302-20230309122948-iqhjnh6.png)
...
![image-20220707222606097](assets/image-20220707222606097-20230309122948-ir6kwza.png)

* 双主双从模式：

![image-20220707222623485](assets/image-20220707222623485-20230309122948-vrhi2o1.png)

### 4.3 垂直拆分

当数据量级达到 `千万级` 以上时，有时候我们需要把一个数据库切成多份，放到不同的数据库服务器上， 减少对单一数据库服务器的访问压力。

![image-20220707222648112](assets/image-20220707222648112-20230309122948-pb9re9n.png)

* 如果数据库的数据表过多，可以采用`垂直分库`的方式，将关联的数据库部署在同一个数据库上。
* 如果数据库中的列过多，可以采用`垂直分表`的方式，将一张数据表分拆成多张数据表，把经常一起使用的列放在同一张表里。

![image-20220707222910740](assets/image-20220707222910740-20230309122948-wjl5r4s.png)
...
![MySQL索引及调优篇.assets/image-20220707222954304.png](assets/image-20220707222954304-20230309122948-7t1wkoy.png)

![image-20220707222739120](assets/image-20220707222739120-20230309122948-r8b962p.png)

![MySQL索引及调优篇.assets/image-20220707223024163.png](assets/image-20220707223024163-20230309122948-ifn7ja6.png)
...
![MySQL索引及调优篇.assets/image-20220707223246684.png](assets/image-20220707223246684-20230309122948-4pq8ryr.png)

![MySQL索引及调优篇.assets/image-20220707223349879.png](assets/image-20220707223349879-20230309122948-68piyjb.png)

### 5.3 MySQL8.0新特性：隐藏索引对调优的帮助

![MySQL索引及调优篇.assets/image-20220707223420496.png](assets/image-20220707223420496-20230309122948-oepljdc.png)
